...
static const flex_int16_t yy_base[14] =
    {   0,
        0,    0,   10,   11,   11,   11,    0,    2,    0,    4,
        0,   11,    6
    } ;

static const flex_int16_t yy_def[14] =
    {   0,
       12,    1,   12,   12,   12,   12,   13,   12,   13,    8,
        8,    0,   12
    } ;
...
char *yytext;
#line 1 "q2_expression.l"
#line 2 "q2_expression.l"
#include <stdio.h>
void operators(char *);
...
case 1:
YY_RULE_SETUP
#line 15 "q2_expression.l"
{ identifiers(yytext); }
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 16 "q2_expression.l"
{ operators(yytext);   }
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 17 "q2_expression.l"
{ specialChar(yytext); }
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 18 "q2_expression.l"
{ constants(yytext);   }
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 19 "q2_expression.l"
ECHO;
	YY_BREAK
#line 759 "lex.yy.c"
